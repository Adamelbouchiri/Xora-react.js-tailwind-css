    ...
    <section>
      <Element name="FAQ" className="relative">
        <div className="container relative z-2 py-28">
          <div className="">
            <h3 className="text-p4 h3 max-md:h5 max-w-640 max-lg:max-w-md mb-7">
          ...
          <div className="faq-line-after w-0.5 absolute h-full left-[calc(50%-1px)] top-0 -z-1 bg-s2" />
        </div>
        ...
        <div className="faq-glow_before relative z-2 border-2 border-s2 bg-s1">
          <div className="container flex gap-10 max-lg:block">
            <div
              ...
              z-4 flex size-20 justify-center items-center border-2 border-s2 bg-s1
            "
            >
