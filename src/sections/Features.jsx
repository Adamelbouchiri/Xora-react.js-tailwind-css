          ...
          >
            {features.map((feature) => (
              ...
              >
                ...
                <p className="caption mb-5 max-md:mb-6 uppercase">
                  {feature.caption}
                </p>
                <h2 className="max-w-400 mb-7 h3 text-p4 max-md:mb-6 max-md:h5 uppercase">
                  {feature.title}
                </h2>
                <p className="mb-11 body-1 max-md:mb-8 max-md:boy-3 uppercase">
                  {feature.text}
                </p>
