      ...
      <Element name="pricing">
        <div className="container">
          <div
            ...
            border-l border-r border-s2 bg-s1/50 pb-40 pt-28 max-xl:max-w-4xl max-lg:border-none
            max-md:pb-32 max-md:pt-16
          "
          >
            <h3
              className="h3 max-lg:h4 max-md:h5 z-3 relative mx-auto mb-14 max-w-lg
              ...
              >
                ...
                {index === 1 && (
                  <p
                    ...
                    before:content-['-'] before:mx-2.5 after:content-['-'] after:mx-2.5 "
                  >
                    Limmited Time Offer
                  </p>
                )}
